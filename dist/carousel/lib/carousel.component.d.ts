...
export declare class MatCarouselComponent implements AfterContentInit, AfterViewInit, MatCarousel, OnDestroy {
    ...
    private startTimer;
    private stopTimer;
    static ɵfac: i0.ɵɵFactoryDeclaration<MatCarouselComponent, never>;
    static ɵcmp: i0.ɵɵComponentDeclaration<MatCarouselComponent, "mat-carousel", never, { "timings": "timings"; "svgIconOverrides": "svgIconOverrides"; "autoplay": "autoplay"; "interval": "interval"; "loop": "loop"; "hideArrows": "hideArrows"; "hideIndicators": "hideIndicators"; "pauseOnHover": "pauseOnHover"; "color": "color"; "maxWidth": "maxWidth"; "maintainAspectRatio": "maintainAspectRatio"; "proportion": "proportion"; "slideHeight": "slideHeight"; "slides": "slides"; "useKeyboard": "useKeyboard"; "useMouseWheel": "useMouseWheel"; "orientation": "orientation"; }, { "animationStart": "animationStart"; "change": "change"; }, ["slidesList"], never, false, never>;
}
